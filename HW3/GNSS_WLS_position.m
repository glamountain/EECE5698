function [est_r_ea_e,est_clock] = GNSS_WLS_position(...
    GNSS_measurements,no_GNSS_meas,predicted_r_ea_e,W)
...
%
%   P. Closas (2018): version only for position and clock offset WLS estimation
% 
